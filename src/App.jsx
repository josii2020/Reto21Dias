 ...
 * ════════════════════════════════════════════
 * 
 * En Lemon Squeezy → Producto → Confirmation page:
 * Redirect URL: https://reto21diasfitnes.lat/?access=RETO21POWER
 */
...
export default function App() {
  ...
  useEffect(() => {
    if (hasAccess) {
      try {
        window.localStorage.setItem("reto21_progress", JSON.stringify({
          completedDays, weights, initialWeight, goalWeight
        }));
      } catch(e) {}
    }
      ...
      <div style={{ fontFamily: sans, background: bg, minHeight: "100vh", color: "#fff" }}>
        ...
        <div style={{ maxWidth: 420, margin: "0 auto", padding: "0 20px" }}>
          ...
          <div style={{ paddingBottom: 40 }}>
            ...
            {[
              { num: "84", text: "Comidas planificadas con calorías y proteínas" },
              { num: "84", text: "Ejercicios progresivos de 3 niveles" },
              { num: "21", text: "Días de contenido desbloqueado al instante" },
              { num: "∞", text: "Acceso de por vida al programa" },
            ].map((item) => (
          ...
          <div style={{ paddingBottom: 50 }}>
            ...
            {[
              { q: "¿Necesito equipo de gimnasio?", a: "No. Todos los ejercicios son con peso corporal, podés hacerlos en casa." },
              { q: "¿Las comidas son difíciles de preparar?", a: "No. Son recetas simples con ingredientes que encontrás en cualquier supermercado." },
              { q: "¿Puedo acceder desde mi celular?", a: "Sí. La webapp funciona perfecto en celular, tablet y computadora." },
              { q: "¿Es un pago único o suscripción?", a: "Pago único de $9.99. Pagás una vez y tenés acceso de por vida." },
            ].map((faq) => (
